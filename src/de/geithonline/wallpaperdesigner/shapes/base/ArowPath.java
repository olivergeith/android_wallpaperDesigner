...
public class ArowPath extends Path {
	...
	public ArowPath(final PointF center, final float radius, final Direction dir) {
		draw(center, radius, dir);
	}

	private void draw(final PointF center, final float radius, final Direction dir) {
