...
public class VirusPath8 extends Path {

	public VirusPath8(final Point center, float radius, final boolean filled) {
		super();
		radius = radius * 2;
		final List<Point> circles = new ArrayList<Point>();
		Point firstPoint = new Point();
		final int arms = Randomizer.getRandomInt(20, 30);
