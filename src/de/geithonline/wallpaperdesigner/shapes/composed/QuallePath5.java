...
public class QuallePath5 extends ComposedPath {
	...
	public QuallePath5(final PointF center, final float radius, final EQualleType type) {
		switch (type) {
		default:
		case qualle:
	...
	private void drawBubbleTail(final PointF center, final float radius) {
		for (int i = 0; i < 15; i++) {
			...
			final Path s = new SinusObjectsPath(c, length, repeats, amplitude, maxBubbleRadius, 85, ESinusObjectsSizingType.decreasing,
