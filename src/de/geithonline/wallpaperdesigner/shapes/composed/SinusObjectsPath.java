...
public class SinusObjectsPath extends ComposedPath {
    ...
    private void drawSinusConnected(final PointF center, final float radius, final int sinRepeats,
    ...
    private void drawSinusGettingSmaller2(final PointF center, final float radius, final int sinRepeats,
            final float amplitude, final float maxBubbleRadius, final int prozentToDraw) {
        // nach links
        final float l = center.x - radius;
        final float r = center.x + radius;
