...
public class QualleTopviewPath extends ComposedPath {
	...
	private void drawInnerQualleV2(final PointF center, final float radius, final EyeOptions eyeOptions) {
		final int anz = Randomizer.getRandomInt(eyeOptions.minAnzEyes, eyeOptions.maxAnzEyes);
		for (int i = 0; i < anz; i++) {
			final PointF c1 = new PointF();
			final PointF c2 = new PointF();
