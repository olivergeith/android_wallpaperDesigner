...
public class MultiSinusLinesPath extends ComposedPath {
	 ...
	 */
	public MultiSinusLinesPath(final PointF center, final float radius, final float minLength, final float maxLength, final int numberofTails,
			final float offset) {
		super();
		drawSinusTail(center, radius, minLength, maxLength, numberofTails, offset);
	}

	private void drawSinusTail(final PointF center, final float radius, final float minLength, final float maxLength, final int numberofTails,
			final float offset) {
