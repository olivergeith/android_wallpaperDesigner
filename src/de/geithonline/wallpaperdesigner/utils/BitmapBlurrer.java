...
public class BitmapBlurrer {
	...
	public static Bitmap fastblur(final Bitmap inputBitmap, final int radius) {
	...
	public static Bitmap blur(final Context ctx, final Bitmap image, final float blurRadius) {
		final int width = Math.round(image.getWidth() * BITMAP_SCALE);
		final int height = Math.round(image.getHeight() * BITMAP_SCALE);
	...
	public static Bitmap doBlur(final Bitmap sentBitmap, final int radius, final boolean canReuseInBitmap) {
