...
public class RasterFactory {
  ...
  static {
    ...
    layoutProperties.put("Geometric Grid", new LayoutProperties(false, true, true, true, false, //
        new CharSequence[] { "Book", "Book Reverse", "Tower", "Center", "Inner to Outer", "Outer to Inner",
            "Random" }));
    ...
    layoutProperties.put("Circular",
        new LayoutProperties(false, true, true, false, true, //
            new CharSequence[] { "Inner to Outer", "Outer to Inner", "Top to Bottom", "Bottom to Top", "Left to Right",
  ...
  public static AbstractRaster getRaster(final String layout, final String variante, final int width, final int height,
      final int patternRadius,
      final float overlap) {
    ...
    case "Geometric Grid (Random)":
      return new GeometricRaster(width, height, patternRadius, overlap, RasterPositioning.RANDOM, Settings
          .isUpsideDown());
    case "Geometric Grid (Book)":
      return new GeometricRaster(width, height, patternRadius, overlap, RasterPositioning.BOOK, Settings
          .isUpsideDown());
    case "Geometric Grid (Book Reverse)":
      return new GeometricRaster(width, height, patternRadius, overlap, RasterPositioning.BOOK_REVERSE, Settings
          .isUpsideDown());
    case "Geometric Grid (Tower)":
      return new GeometricRaster(width, height, patternRadius, overlap, RasterPositioning.TOWER, Settings
          .isUpsideDown());
    case "Geometric Grid (Center)":
      return new GeometricRaster(width, height, patternRadius, overlap, RasterPositioning.CENTER, Settings
          .isUpsideDown());
    case "Geometric Grid (Outer to Inner)":
      return new GeometricRaster(width, height, patternRadius, overlap, RasterPositioning.OUTER, Settings
          .isUpsideDown());
    case "Geometric Grid (Inner to Outer)":
      return new GeometricRaster(width, height, patternRadius, overlap, RasterPositioning.INNER, Settings
          .isUpsideDown());
    ...
    case "Hex Grid (Random)":
      return new HexagonalRaster(width, height, patternRadius, overlap, RasterPositioning.RANDOM, Settings
          .isUpsideDown());
    case "Hex Grid (Book)":
      return new HexagonalRaster(width, height, patternRadius, overlap, RasterPositioning.BOOK, Settings
          .isUpsideDown());
    case "Hex Grid (Book Reverse)":
      return new HexagonalRaster(width, height, patternRadius, overlap, RasterPositioning.BOOK_REVERSE, Settings
          .isUpsideDown());
    case "Hex Grid (Tower)":
      return new HexagonalRaster(width, height, patternRadius, overlap, RasterPositioning.TOWER, Settings
          .isUpsideDown());
    case "Hex Grid (Center)":
      return new HexagonalRaster(width, height, patternRadius, overlap, RasterPositioning.CENTER, Settings
          .isUpsideDown());

    case "Diagonal Grid (Random)":
      return new DiagonalRaster(width, height, patternRadius, overlap, RasterPositioning.RANDOM, Settings
          .isUpsideDown());
    ...
    case "Diagonal Grid (Book Reverse)":
      return new DiagonalRaster(width, height, patternRadius, overlap, RasterPositioning.BOOK_REVERSE, Settings
          .isUpsideDown());
    case "Diagonal Grid (Tower)":
      return new DiagonalRaster(width, height, patternRadius, overlap, RasterPositioning.TOWER, Settings
          .isUpsideDown());
    case "Diagonal Grid (Center)":
      return new DiagonalRaster(width, height, patternRadius, overlap, RasterPositioning.CENTER, Settings
          .isUpsideDown());
    ...
    case "Spiral (Bottom to Top)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.BOTTOMMOST,
          CIRCLE_TYPE.SPIRAL);
    ...
    case "Circular (Random)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.RANDOM,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
    case "Circular (Inner to Outer)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.INNER,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
    case "Circular (Outer to Inner)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.OUTER,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
    case "Circular (Top to Bottom)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.TOPMOST,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
    case "Circular (Bottom to Top)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.BOTTOMMOST,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
    case "Circular (Left to Right)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.LEFTMOST,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
    case "Circular (Right to Left)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.RIGHTMOST,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
    case "Circular (Center)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.CENTER,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
    case "Circular (Tower)":
      return new CircularRaster(width, height, patternRadius, overlap, RasterPositioning.TOWER,
          CIRCLE_TYPE.FULL_RANDOM_STARWINKEL);
