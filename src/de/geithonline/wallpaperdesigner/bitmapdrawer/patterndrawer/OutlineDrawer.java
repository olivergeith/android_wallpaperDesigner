...
public class OutlineDrawer {
	...
	public static void setupPaintForOutline(final Paint paint, final int radius) {
		setupPaintForStroke(paint, radius);
		paint.setShadowLayer(0, 0, 0, 0); // dropshadow weg
		setupOutlineColor(paint);
	}
	...
	public static void setupOutlineColor(final Paint paint) {
	...
	public static void setupPaintForStroke(final Paint paint, final int radius) {
