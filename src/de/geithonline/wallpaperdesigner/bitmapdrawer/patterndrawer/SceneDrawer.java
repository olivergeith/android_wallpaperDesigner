...
public class SceneDrawer {
    ...
    public void drawHeartWithTrail(final int x, final int y, final Paint paint, final int radius, final boolean filled,
            final HEART_TRAIL_TYPE type) {
    ...
    public void drawQualle(final int x, final int y, final Paint paint, final int radius, final boolean filled,
            final HEART_TRAIL_TYPE type) {
        final Path qualle = new CirclePath(new PointF(x - radius / 2, y), radius / 2, 0, filled,
