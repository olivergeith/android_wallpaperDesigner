...
public class PatternPropertyStore {
  ...
  private static final Map<String, PatternProperties> patternProperties = new HashMap<>();
  ...
  static {
    ...
    patternProperties.put("Assorted Shapes", new PatternProperties(true, true, false, true, false, true, //
        new CharSequence[] { "Lemon", "YingYang", "Crop Circles", "Roses", "Pillows", "Android", "Ikae Robot",
            "Footprint", "Pentagram", "4Sails",
            "Dice", "Drop", "Hedgehog", "Dandelion", "Deathstar", "R2D2", "Sonic", "Iron Cross", "Iron Cross (round)",
            "Mixed" }));
    ...
    patternProperties.put("Geometrical (long) Shapes", new PatternProperties(true, true, false, true, false, false, //
        new CharSequence[] { "Rectangle", "Rectangle (rounded)", "Rectangle (Mixed)", //
            "Triangle", "Oval", "Diamond", "Dragon", "Dragon (upsidedown)", "Drop", "Drop (upsidedown)", "Lense",
            "Lense V2", "Lense V3", //
            ...
            "Iron Cross (round)", //
            "Bird", "Bird V2", "Golf Pin", "Pin", "Tulip (Slim)", "Tulip", "Tulip (Fat)", "Plane", "Spaceship",
            "Spaceship V2", "Ritual Axe",
            "Arrow" }));
    ...
    patternProperties.put("Invertable Shapes", new PatternProperties(true, true, false, true, false, true, //
        new CharSequence[] { "Heart V1", "Heart V2", "Arrow", "Arrow (round)", "Plus", "Minus", "Star", "Gear", "Crown",
            "Mixed",
            "Mixed Plus-Minus" }));
    ...
    patternProperties.put("Logos", new PatternProperties(true, true, false, false, false, true, //
        new CharSequence[] { "Resurrection Remix", "Resurrection Remix V2", "Resurrection Remix V3",
            "Resurrection Remix V4", "Resurrection Remix V5",
            "Resurrection Remix V6", "ElementalX Kernel", "Peace Sign", "Weed Sign", "Weed Sign V2", "Nexus V1",
            "Nexus V2", "Nexus V3",
            "Oneplus One V1", "Oneplus One V2", "LG V1", "LG V2" }));
    ...
    patternProperties.put("Material", new PatternProperties(true, false, false, false, false, false, //
        new CharSequence[] { "Stripe", "Stripe V2", "Stripe V3", "Half Stripe", "Half Stripe V2", "Half Stripe V3",
            "Arc 1", "Arc 2", "Arc 3",
            "Skyline", "Pyramide Skyline", "Edgy Bars", "Rotating Bars", "Rotating Triangles",
            "Rotating Arches (random arches)",
    ...
    patternProperties.put("Pillows", new PatternProperties(true, true, false, false, false, true, //
        new CharSequence[] { "3 Edge Pillow", "4 Edge Pillow", "5 Edge Pillow", "6 Edge Pillow", "Plectrum",
            "Fingernail", "Treky", "YingYang", "Peeek",
            "Armor", "Messer", "Blazon", "Mixed" }));
    ...
    patternProperties.put("Rings", new PatternProperties(true, true, false, true, false, true, //
        new CharSequence[] { "Rings V1 (Flange)", "Rings V2 (Asymetric)", "Rings V3 (Concentric)", "Rings V4 (Dizzy)",
            "Mixed" }));

    patternProperties.put("Scenes", new PatternProperties(true, true, false, true, false, true, //
        new CharSequence[] { "Rain", "Trail Of Stars", "Trail Of Boxes", "Experiemental" }));
    ...
    patternProperties.put("Spooky", new PatternProperties(true, true, false, false, false, true, //
        new CharSequence[] { "Skull", "Bat V1 (Aarons Cute Design)", "Bat V2", "Bat V3", "Bat V4", "Ghost V1",
            "Ghost V2", "Owl V1", "Owl V2", "Owl V3",
            "Owl V4", "Pumpkin (round eyes)", "Pumpkin (triangel eyes)", "Pumpkin (round eyes and mouth)", "Mixed",
            "Mixed Pumpkins", "Mixed Bats",
            "Mixed Ghosts", "Mixed Owls" }));

    patternProperties.put("Space", new PatternProperties(true, true, false, true, false, true, //
        new CharSequence[] { "Rocket V1", "Rocket V2", "Rocket V3", "Rocket V4", "Rocket V5", "Rocket V6", "Ufo V1",
            "Ufo V2", "Satellite", "Spaceship",
            "Mixed Rockets", "Mixed" }));
    ...
    patternProperties.put("Square", new PatternProperties(true, true, false, true, false, true, //
        new CharSequence[] { "Square (round inner corner)", "Square (round inner corner V2)", "Square (rounded)",
            "Square (square inner corner)",
            "Square (line corner)", "Square (circle corner)", "Square (outer circle corner)", "Square (castel)" }));
    ...
    patternProperties.put("Weather", new PatternProperties(true, true, false, true, true, true, //
        new CharSequence[] { "Sun", "Cloud", "Sun with Flames", "Sun with Flames (Drop Style)",
            "Sun with Flames (Triangle)",
