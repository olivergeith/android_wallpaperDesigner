...
public class PatternPropertyStore {
	...
	static {
		...
		patternProperties.put("Circular", new PatternProperties(true, true, false, false, false, true, //
				new CharSequence[] { "Maze", "Maze V2", "Beam", "Beam V2", "Beam V3", "Arcs rotated", "Arcs rotated evenly" }));
		...
		patternProperties.put("Geometrical (long) Shapes", new PatternProperties(true, true, false, true, false, false, //
				new CharSequence[] { "Rectangle", "Rectangle (rounded)", "Rectangle (Mixed)", //
						...
						"Bird", "Bird V2", "Golf Pin", "Pin", "Tulip (Slim)", "Tulip", "Tulip (Fat)", "Plane", "Spaceship", "Spaceship V2", "Ritual Axe",
						"Arrow" }));
		...
		patternProperties.put("Jellyfish", new PatternProperties(true, true, false, true, true, true, //
				new CharSequence[] { //
						...
						"V3 (Oval)", //
						"Mixed" }));
		patternProperties.put("Jellyfish Topview", new PatternProperties(true, true, false, false, false, true, //
				new CharSequence[] { //
						"Fully customizable", //
						"Preset 1", //
						"Preset 2", //
		...
		patternProperties.put("Logos", new PatternProperties(true, true, false, false, false, true, //
				new CharSequence[] { "Resurrection Remix", "Resurrection Remix V2", "Resurrection Remix V3", "Resurrection Remix V4", "Resurrection Remix V5",
						"Resurrection Remix V6", "ElementalX Kernel", "Peace Sign", "Weed Sign", "Weed Sign V2", "Nexus V1", "Nexus V2", "Nexus V3",
						"Oneplus One V1", "Oneplus One V2", "LG V1", "LG V2", "Quake", "Moto", "Moto (inverted)" }));
		...
		patternProperties.put("Penguin", new PatternProperties(true, true, false, false, false, true, //
				new CharSequence[] { "V1", "Mixed" }));

		patternProperties.put("Pillows", new PatternProperties(true, true, false, false, false, true, //
				new CharSequence[] { "3 Edge Pillow", "4 Edge Pillow", "5 Edge Pillow", "6 Edge Pillow", "Plectrum", "Fingernail", "Treky", "YingYang", "Peeek",
						"Armor", "Messer", "Blazon", "Wurfstern", "Mixed" }));
		...
		patternProperties.put("Spooky", new PatternProperties(true, true, false, false, false, true, //
				new CharSequence[] { "Skull", "Bat V1 (Aarons Cute Design)", "Bat V2", "Bat V3", "Bat V4", "Ghost V1", "Ghost V2", "Owl V1", "Owl V2", "Owl V3",
						"Owl V4", "Pumpkin (round eyes)", "Pumpkin (triangel eyes)", "Pumpkin (round eyes and mouth)", "Mixed", "Mixed Pumpkins", "Mixed Bats",
						"Mixed Ghosts", "Mixed Owls" }));

		patternProperties.put("Square", new PatternProperties(true, true, false, true, false, true, //
				new CharSequence[] { "Square (round inner corner)", "Square (round inner corner V2)", "Square (rounded)", "Square (square inner corner)",
