    ...
    patternProperties.put("Assorted Shapes",
        new PatternProperties(true, true, false, true, false, true, //
            new CharSequence[] { "Lemon", "YingYang", "Crop Circles", "Roses", "Pillows", "Android", "Ikae Robot",
                "Footprint", "Pentagram",
                "4Sails", "Dice", "Drop", "Hedgehog", "Dandelion", "Deathstar", "R2D2", "Sonic", "Iron Cross",
                "Iron Cross (round)",
                "Mixed" }));
    ...
    patternProperties.put("Logos",
        new PatternProperties(true, true, false, false, false, true, //
            new CharSequence[] { "Resurrection Remix", "Resurrection Remix V2", "Resurrection Remix V3",
                "Resurrection Remix V4",
                "Resurrection Remix V5", "Resurrection Remix V6", "ElementalX Kernel", "Peace Sign", "Weed Sign",
                "Weed Sign V2", "Nexus V1",
    ...
    patternProperties.put("Spooky",
        new PatternProperties(true, true, false, false, false, true, //
            new CharSequence[] { "Skull", "Bat V1 (Aarons Cute Design)", "Bat V2", "Bat V3", "Bat V4", "Ghost V1",
                "Ghost V2", "Owl V1", "Owl V2",
                "Owl V3", "Owl V4", "Pumpkin (round eyes)", "Pumpkin (triangel eyes)", "Pumpkin (round eyes and mouth)",
                "Mixed",
