...
public class GlossyDrawer {
    ...
    public void draw(final int x, final int y, final Paint paint, final int radius, final Path path,
            final GLOSSY_REFLECTIONS_STYLE reflectionStyle, final GLOSSY_GLOW_STYLE glowStyle,
            final boolean ignoreIsGlossy) {
    ...
    private void paintBubbleGlossyOval(final PointF pos, final float radiusW, final float radiusH, final Paint paint,
            final Path path) {
    ...
    private static void setupPaintShaderVerticalRainbowGlow(final int x, final int y, final Paint paint,
            final int radius) {
        paint.setShadowLayer(0, 0, 0, 0);
    ...
    private void setupPaintShaderDiagonalCurvedReflection(final int x, final int y, final Paint paint,
            final int radius) {
        final int white2 = Color.argb(Settings.getGlossyReflectionBrightness(), 255, 255, 255);
        final int transparent = Color.argb(0, 255, 255, 255);
    ...
    private void setupPaintShaderCurvedFromTopReflection(final int x, final int y, final Paint paint,
            final int radius) {
        final int white2 = Color.argb(Settings.getGlossyReflectionBrightness(), 255, 255, 255);
        final int transparent = Color.argb(0, 255, 255, 255);
        final int colors[] = { transparent, transparent, white2, transparent };
