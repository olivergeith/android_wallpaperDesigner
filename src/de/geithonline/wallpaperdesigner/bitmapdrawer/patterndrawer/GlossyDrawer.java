...
public class GlossyDrawer {
	...
	public void draw(final int x, final int y, final Paint paint, final int radius, final Path path, final EGlossyReflectionStyle reflectionStyle) {
		draw(x, y, paint, radius, path, reflectionStyle, Settings.getGlossyGlowStyle(), false);
	}

	public void draw(final int x, final int y, final Paint paint, final int radius, final Path path, final EGlossyReflectionStyle reflectionStyle,
			final EGlossyGlowStyle glowStyle, final boolean ignoreIsGlossy) {
