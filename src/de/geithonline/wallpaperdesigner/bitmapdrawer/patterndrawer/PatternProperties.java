...
public class PatternProperties {
    ...
    public PatternProperties(final boolean outlineOption, final boolean randomrotateOption, final boolean textOption,
            final boolean filledOption, final boolean leafOption, final boolean glossyOption,
            final CharSequence[] variants) {
        super();
