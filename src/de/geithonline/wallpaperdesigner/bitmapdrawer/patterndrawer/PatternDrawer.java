...
public class PatternDrawer {
	...
	protected void drawLinesDirected(final int x, final int y, final Paint paint, final int radius, final String variant) {
		Path path;
		switch (variant) {
		default:
		case "V1":
	...
	public void drawScene(final int x, final int y, final Paint paint, final int radius, final String variant, final int index) {
		switch (variant) {
		default:
		case "Rain":
			if (index % 40 == 0) {
