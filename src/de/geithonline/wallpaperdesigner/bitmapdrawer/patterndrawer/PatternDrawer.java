...
public class PatternDrawer {
  ...
  protected void drawLines(final int x, final int y, final int radius, final String variant) {
    ...
    case "V1":
    case "Spirals":
      path = new SpiralPath(Randomizer.getRandomInt(3, 5), new Point(x, y), radius,
          Randomizer.getRandomBoolean());
      break;
    case "V2":
    case "Streamers":
      path = new LuftschlangenPath(Randomizer.getRandomInt(6, 7), new Point(x, y), radius,
          Randomizer.getRandomBoolean());
      break;
    case "V3":
    case "Maze":
  ...
  protected void drawChess(final int x, final int y, final int radius, final String variante) {
    ...
    case "V7":
    case "Triangle":
      path = new SchachbrettPath(new PointF(x, y), radius, Randomizer.getRandomInt(1, 4),
