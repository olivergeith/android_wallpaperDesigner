...
public class PatternDrawer {
	...
	private void drawQualle(final int x, final int y, final int radius, final String variante) {
		...
		case "V1 (Half Circle)":
		case "Jellyfish":
			path = new QuallePath(new PointF(x, y), radius, EQualleType.v1);
			break;
		case "V2":
		case "V2 (UFO)":
		case "Jellyfish 2":
			path = new QuallePath(new PointF(x, y), radius, EQualleType.v2);
			break;
		case "V3":
		case "V3 (Oval)":
		case "Jellyfish 3":
			path = new QuallePath(new PointF(x, y), radius, EQualleType.v3);
			break;
		}
