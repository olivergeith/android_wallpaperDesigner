...
public class BmpRenderer extends BaseBmpRenderer {
	...
	private AsyncTaskWithProgress task;
	private final ELayout layout;
	private final ELayoutVariant layoutVariante;
	...
	@Override
	public synchronized Bitmap drawBitmap(final AsyncTaskWithProgress bitmapWorkerTask) {
