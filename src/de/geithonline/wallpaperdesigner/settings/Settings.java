...
public class Settings {
	...
	public static CircularMazeOptions getCircularMazeOptions() {
		...
		circularMazeOptions.coloringType = ComposedPathColoringType
				.enumForName(readStringPref("CMazeOptions.coloringType", "Normal"));
	...
	public static ColorRandOptions getColorRandomizingOptions() {
		colorRandomizingOptions.randomizingType = COLOR_RANDOMIZING_TYPE
				.enumForName(readStringPref(ColorRandOptions.KEY_COLOR_RANDOMIZING_TYPE, "full RGB"));
		...
		colorRandomizingOptions.minBrightnessRange = readIntegerPref(ColorRandOptions.KEY_COLOR_MIN_BRIGHTNESS_RANGE,
				-32);
		colorRandomizingOptions.maxBrightnessRange = readIntegerPref(ColorRandOptions.KEY_COLOR_MAX_BRIGHTNESS_RANGE,
				32);
		colorRandomizingOptions.minSaturationRange = readIntegerPref(ColorRandOptions.KEY_COLOR_MIN_SATURATION_RANGE,
				0);
		colorRandomizingOptions.maxSaturationRange = readIntegerPref(ColorRandOptions.KEY_COLOR_MAX_SATURATION_RANGE,
				0);
	...
	/**
	 * calculates the rate after how many patterns the image has to be refreshed.
	 * <br>
	...
	public static TailOptionsBubbles getTailOptionsBubbles() {
		...
		bubbleOptions.tailRotationType = TailRotationType
				.enumForName(readStringPref("TailOptionsBubbles.tailRotationType", "Even"));

		bubbleOptions.sinusAmplitudeType = SinusAmplitudeType
				.enumForName(readStringPref("TailOptionsBubbles.sinusAmplitudeType", "Normal"));
		bubbleOptions.sinusObjectsSizingType = ESinusObjectsSizingType
				.enumForName(readStringPref("TailOptionsBubbles.sinusObjectSizingType", "Decreasing"));
		bubbleOptions.sinusObjectType = ESinusObjectsType
				.enumForNameUsedInQualle(readStringPref("TailOptionsBubbles.sinusObjectType", "Bubble"));
	...
	public static TailOptionsLine getTailOptionsLine() {
		...
		lineOptions.tailRotationType = TailRotationType
				.enumForName(readStringPref("TailOptionsLine.tailRotationType", "Even"));
		lineOptions.sinusAmplitudeType = SinusAmplitudeType
				.enumForName(readStringPref("TailOptionsLine.sinusAmplitudeType", "Normal"));
