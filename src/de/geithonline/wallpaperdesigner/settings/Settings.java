...
public class Settings {
	...
	public enum TailLineType {
		No, Sinus, Straight;
		public static TailLineType enumForName(final String name) {
			switch (name) {
			default:
			case "No":
				return TailLineType.No;
			case "Sinus":
				return TailLineType.Sinus;
			case "Straight":
				return TailLineType.Straight;
			}
		}
	}
