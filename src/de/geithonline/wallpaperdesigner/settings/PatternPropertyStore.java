...
public class PatternPropertyStore {
	...
	static {
		...
		patternProperties.put("Material", new PatternProperties(true, false, false, false, false, false, //
				new CharSequence[] { "Stripe", "Stripe V2", "Stripe V3", "Half Stripe", "Arc 1", "Arc 2", "Arc 3",
						"Skyline", "Edgy Bars", "Rotating Bars", "Rotating Triangles",
						"Rotating Arches (random arches)", "Rotating Arches (quarter arches)",
